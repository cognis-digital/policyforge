...
[![PyPI](https://img.shields.io/pypi/v/cognis-policyforge.svg)](https://pypi.org/project/cognis-policyforge/)
[![CI](https://github.com/cognis-digital/policyforge/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/policyforge/actions)
...
POLICYFORGE exists for one job — auto-generate security policies from a short questionnaire — and does it without a SaaS bill or heavyweight setup.
...
```bash
policyforge --version
policyforge scan .                      # scan the current project
policyforge scan . --format json
policyforge scan . --fail-on high       # non-zero exit for CI gates
policyforge mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **Comp AI**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`policyforge` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
