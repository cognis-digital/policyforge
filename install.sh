#!/usr/bin/env sh
# Universal installer for policyforge. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/policyforge.git"
echo "Installing policyforge ..."
...
echo "Done. Run: policyforge --help"
