"""POLICYFORGE core — Auto-generate security policies from a short questionnaire."""
...
RULES = [
    ("POL-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("POL-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("POL-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
