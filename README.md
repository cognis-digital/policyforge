...
<img src="https://capsule-render.vercel.app/api?type=rect&color=0:6b46c1,100:2b6cb0&height=120&section=header&text=POLICYFORGE&fontSize=48&fontColor=ffffff&fontAlignY=58" width="100%" alt="POLICYFORGE"/>

# POLICYFORGE

### Auto-generate security policies from a short questionnaire

<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=18&duration=3500&pause=1000&color=6B46C1&center=true&vCenter=true&width=720&lines=Autogenerate+security+policies+from+a+short+questionnaire;Self-hostable+%C2%B7+MCP-native+%C2%B7+CI-ready+%C2%B7+polyglot" width="720"/>

[![PyPI](https://img.shields.io/pypi/v/cognis-policyforge.svg?color=6b46c1)](https://pypi.org/project/cognis-policyforge/) [![CI](https://github.com/cognis-digital/policyforge/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/policyforge/actions) [![License: COCL 1.0](https://img.shields.io/badge/License-COCL%201.0-2b6cb0.svg)](LICENSE) [![Suite](https://img.shields.io/badge/Cognis-Neural%20Suite-6b46c1.svg)](https://github.com/cognis-digital)
...
- [Why policyforge?](#why) · [Features](#features) · [Quick start](#quick-start) · [Example](#example) · [How it compares](#how-it-compares) · [Integrations](#integrations) · [Install anywhere](#install-anywhere) · [Related](#related) · [Contributing](#contributing)
...
Pipes into your stack: **SARIF** for code-scanning, **JSON** for anything, an **MCP server** (`policyforge mcp`) for AI agents, and a webhook forwarder for SIEM/Slack/Jira. See [`docs/INTEGRATIONS.md`](docs/INTEGRATIONS.md).
...
|---|---|---|---|---|
| `scripts/setup-linux.sh` | `scripts/setup-macos.sh` | `scripts/setup-windows.ps1` | `docker run ghcr.io/cognis-digital/policyforge` | [DEPLOY.md](docs/DEPLOY.md) (AWS/Azure/GCP/k8s) |
