"""Native cognis-connect emit for policyforge — forward findings to any platform.

Maps policyforge's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    policyforge ... --format json | policyforge-emit --to stix
    policyforge-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
